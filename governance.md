...
_NOTE: Prior to December 2022, Project Jupyter had a governance model based on a BDFL and a Steering Council, as described in this document._
...
has voted and 2/3 of the votes are in favor (fractions of a vote rounded up to the nearest integer), the proposal passes. Since the BDFL holds ultimate
